...
public class App1 {
	...
	public static void main(String[] args) throws Exception {
		...
		/*
		 * BufferedReader
		 * 	- 다른 Reader와 연결해서 읽기 성능을 향상시키는 스트림이다.
		 * 	- 텍스트를 한 줄씩 읽어오는 readLine() 메소드를 제공한다.
		 * 	- 주요 메소드
		 * 		String readLine()
		 * 			- 텍스트 내용을 한 줄씩 읽어오는 스크림이다.
